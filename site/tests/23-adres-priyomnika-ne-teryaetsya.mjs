...
ok("B1 текст заявки кладётся в поле карточки", /const noteF = entity\.fields\?\.find\(\(f: Any\) => f\.type === "textarea"\);[\s\S]{0,200}values\[noteF\.id\] = msg\.text/.test(hook));
...
ok("B4 версия приёмника поднята", /const VERSION = "0\.19"/.test(hook));
