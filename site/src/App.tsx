    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-2.5 px-4 pb-4 pt-[18px]">
          ...
          <span className="font-mono2 ml-auto text-[9.5px] text-muted-foreground/70">v0.20</span>
        </div>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <footer className="hidden h-7 shrink-0 items-center gap-3 border-t px-3.5 sm:flex">
          <span className="font-mono2 text-[10px] text-muted-foreground">XXLcrm v0.20 · правила не перезаряжают себя, задачи не воскресают и не падают на ночь, числа из Excel и 1С, импорт отчитывается</span>
